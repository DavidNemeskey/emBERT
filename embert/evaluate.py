...
class Evaluator:
    def __init__(self, model: nn.Module, wrapper: DataWrapper,
        ...
        :param it_wrapper: a callable that wraps the data stream generated by
                           ...
                           is ``None``.
        :param record_label_ids: return not just the prediction, but the label
                                 ids as well. Useful for evaluation.
        """
        self.model = model
        self.wrapper = wrapper
        ...
        self.record_label_ids = record_label_ids
